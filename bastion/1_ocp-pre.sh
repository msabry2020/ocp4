...
wget -nc --no-check-certificate $BASE_URL/x86_64/clients/ocp/$OCP_VERSION/openshift-client-linux-$OCP_VERSION.tar.gz -P /tmp
...
tar --skip-old-files -xvf /tmp/openshift-client-linux-$OCP_VERSION.tar.gz -C /usr/bin/
